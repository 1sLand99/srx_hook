...
pub use api::{
    ...
    RECORD_ITEM_SYM_NAME, RECORD_ITEM_TIMESTAMP, add_dlopen_callback, add_ignore, clear,
    del_dlopen_callback, dump_records, enable_debug, enable_sigsegv_protection, get_debug,
